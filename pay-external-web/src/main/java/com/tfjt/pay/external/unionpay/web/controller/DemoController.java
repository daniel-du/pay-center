...
//        return Result.ok(demoService.page(page, Wrappers.query(userEntity) ));
        ...
        //回调地址
        extra.put("notifyUrl", "http://uagp2g.natappfree.cc/tf-pay-external/demo/user/withdrawalCallback");
    ...
    public Result<ConsumerPoliciesCheckRespDTO> listCheck() {
        ...
        //合并消费担保下单子订单系统订单号
        consumerPoliciesCheckReqDTO.setGuaranteePaymentId("3308706297495007304");
        ...
        GuaranteePaymentDTO guaranteePaymentDTO = new GuaranteePaymentDTO();
        // 付款方电子账簿ID
        guaranteePaymentDTO.setRecvBalanceAcctId("2008362494748960292");
        guaranteePaymentDTO.setAmount(1);
    ...
    public Result<WithdrawalCreateRespDTO> withdrawalCreation() {
        ...
        //电子账簿ID
        withdrawalCreateReqDTO.setBalanceAcctId("2008362494748960292");
        withdrawalCreateReqDTO.setBusinessType("1");
        //提现目标银行账号 提现目标银行账号需要加密处理  6228480639353401873
        withdrawalCreateReqDTO.setBankAcctNo(UnionPaySignUtil.SM2(encodedPub, "6222030402000890604"));
        //提现至非绑定账户时 必填 枚举值： 1-对私银行卡 2-对公银行账户
        withdrawalCreateReqDTO.setBankAcctType("1");
...
//        withdrawalCreateReqDTO.setBankMemo(""); //银行附言
        //手机号 需要加密处理
        withdrawalCreateReqDTO.setMobileNumber(UnionPaySignUtil.SM2(encodedPub, "18712942960"));
