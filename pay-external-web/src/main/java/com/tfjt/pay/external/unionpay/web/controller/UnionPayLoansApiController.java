...
public class UnionPayLoansApiController {
    ...
    public Result<?> settleAcctsValidate(Integer id, Integer payAmount){
        try {
            return Result.ok(yinLianLoansApiService.settleAcctsValidate(id, payAmount));
        } catch (TfException e) {
            log.error("YinLianLoansApiController.settleAcctsValidate.err:{}" , e);
            return Result.failed(e.getCode(),e.getMessage());
        } catch (Exception e) {
            log.error("银联-货款-打款金额验证：param={}", id, e);
            return  Result.failed(e.getMessage());
        }
    }
    /**
    ...
    public Result<?> getSettleAcctId(Integer id){
        try {
            return Result.ok(yinLianLoansApiService.getSettleAcctId(id));
        } catch (TfException e) {
            log.error("YinLianLoansApiController.getSettleAcctId.err:{}" , e);
            return Result.failed(e.getCode(),e.getMessage());
        } catch (Exception e) {
            log.error("银联-货款-绑定账户编号查看：param={}", id, e);
            return  Result.failed(e.getMessage());
        }
    }
    ...
    public Result<?> querySettleAcctByOutRequestNo(Integer id){
        try {
            ...
            return Result.ok(yinLianLoansApiService.querySettleAcctByOutRequestNo(id, LoanUserEntity.getOutRequestNo()));
        } catch (TfException e) {
            log.error("YinLianLoansApiController.绑定账户查询.err:{}" , e);
            return Result.failed(e.getCode(),e.getMessage());
        } catch (Exception e) {
            log.error("银联-货款-绑定账户查询：param={}", id, e);
            return  Result.failed(e.getMessage());
        }
    }
