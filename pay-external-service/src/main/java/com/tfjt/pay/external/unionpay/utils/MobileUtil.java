...
public class MobileUtil {
    ...
    private static final String MOBILE_PATTERN = "^[1][2,3,4,5,6,7,8,9][0-9]{9}$";


    private static final String REGEX = "^1\\d{12}$";
    ...
    public static boolean checkPhone(String phone) {
        if (StringUtils.isNotBlank(phone)) {
            ...
            return checkChinaMobile(phone) || checkChinaUnicom(phone) || checkChinaTelecom(phone) || regexp.matcher(phone).matches();
        }
        return false;
    }
    ...
    public static void main(String[] args) {
        System.out.println(checkPhone("19358088591"));
    }
